...
class WebhookControllerTest {
    ...
    class TestConfig {
        @Bean
        @Primary
        fun llmPort(): LlmPort = FakeLlmService(failureRate = 0.0f)
    }
    ...
    @Test
    fun `should accept message and return 202 and then process it`() {
        ...
        runBlocking {
            val messageId = MessageId(response.messageId)
